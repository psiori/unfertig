...
(() => {
  ...
  function nextStep(todo, run) {
    ...
    if (['ready','test_failed','tested','merge_failed','push_failed','restart_failed'].includes(run.phase)) return ['merge','Merge & restart',true];
