...
class ConfigurationTests(unittest.TestCase):
    ...
    def test_port_configuration_and_validation(self):
        ...
        self.assertEqual(json.loads(config.read_text()),{'format_version':FORMAT_VERSION,'port':DEFAULT_PORT,'workflow':{'automatic':False,'enabled':False,'max_workers':4,'automatic_merge':False,'automatic_publish':False,'automatic_deploy':False},'processing':{'enabled':True,'automatic':False,'idle_seconds':600,'closed_seconds':90}})
