...
class ConfigurationTests(unittest.TestCase):
    ...
    def test_port_configuration_and_validation(self):
        ...
        self.assertEqual(json.loads(config.read_text()),{'format_version':FORMAT_VERSION,'port':DEFAULT_PORT,'processing':{'enabled':True,'automatic':False,'idle_seconds':600,'closed_seconds':90}})
