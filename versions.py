...
def saved_scope_format(value, kind):
    # Retain established missing-field defaults; never invent editor grants.
...
def relaxed_integration_format(value, kind):
    value = saved_scope_format(value, kind)
...
MIGRATIONS = {'0.0.0': introduce_version, '1.0.0': useful_defaults,
              ...
              '1.17.0': worker_capacity_format, '1.18.0': bugfix_category_format, '1.19.0': publication_hooks_format, '1.20.0': execution_profiles_format, '1.21.0': saved_scope_format,
              '1.22.0': relaxed_integration_format}
