...
def inspect(value, label='data', supported=FORMAT_VERSION, field='format_version'):
    ...
    if found < current and field == 'format_version' and version not in ('0.0.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0'):
...
MIGRATIONS = {'0.0.0': introduce_version, '1.0.0': useful_defaults,
              '1.1.0': aggregation_format, '1.2.0': transport_format, '1.3.0': processing_format, '1.4.0': workflow_format, '1.5.0': workflow_switch_format}
