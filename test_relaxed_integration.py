...
class PolicyTests(unittest.TestCase):
    def test_defaults_validation_and_every_supported_migration(self):
        ...
        self.assertEqual(inspect({'format_version':FORMAT_VERSION}, supported='1.21.0')[0], 'read_only')
        ...
        for value in (None, False, 'invalid'):
            self.assertEqual(migrate({'format_version':'1.21.0','workflow':{'integration':value}}, 'config')['workflow']['integration'], value)
